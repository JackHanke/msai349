...
if __name__ == '__main__':
  testID3AndEvaluate()
  print(f'>> tested ID3 and evaluated')
  testPruning()
  print(f'>> tested pruning')
  testID3AndTest()
  print(f'>> tested ID3 again?')
  testPruningOnHouseData(f'house_votes_84.data')
  print(f'>> tested ID3 on house data')
